...
const passwordSchema = z.object({
    password: z.string().min(8, "Password must contain atleast 8 characters").refine((password) => {
...
function SignUpPage() {
    ...
    const handleSubmit = (data: z.infer<typeof formSchema>) => {
        console.log("Login validation Successfull", data)
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="number" min={8} placeholder="Employees" {...field} value={field.value ?? ""} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )} />
