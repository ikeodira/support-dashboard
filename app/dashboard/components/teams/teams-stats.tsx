...
const teamLeaders: { firstName: string, lastName: string, avatar?: any }[] = [
    {
        firstName: "Colin",
        lastName: "Murray",
        avatar: cm,
                            ...
                            <TooltipProvider key={`${teamLeader.firstName}${teamLeader.lastName}`}>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Avatar>
                                            {!!teamLeader.avatar && <Image src={teamLeader.avatar} alt={`${teamLeader.firstName} ${teamLeader.lastName} avatar`} />}
                                            <AvatarFallback>
                                    ...
                                    <TooltipContent className='dark:text-white cursor-pointer'>
